...
const PROJECTS = [
  ...
  },
  {
    ...
    title: "Agro Nova",
    desc: "AgroNova appears to be an agriculture technology platform aimed at improving farming efficiency through digital tools. The system may include features such as crop monitoring, environmental data tracking, predictive analytics, or farm management dashboards. It likely leverages modern technologies to assist farmers or agribusinesses in making data-driven decisions, potentially integrating IoT or machine learning for insights like yield prediction or disease detection.",
  ...
  },
  {
    ...
    title: "Thinknode Freelance Project",
    desc: "Thinknode-customer appears to be a customer-facing web application designed for a ThinkNode-based ecosystem. The project likely serves as the frontend interface where users can interact with backend services such as data processing, AI-driven features, or cloud-based workflows. It may include functionalities like user authentication, dashboards, service requests, and real-time data visualization. The architecture suggests a typical SaaS-style platform where customers access tools or analytics through a browser interface.",
